...
site:
  ...
  name:
    ...
    custom: Ankai Liang / ex-Googler / ByteDancer
  # 网页icon
  # Web icon
...
nav:
  ...
  # center menu
  menu:
    Home: / # 显示名称：路径 / Display name: path
    Articals: # 显示名称 / Display name
      Artical List: /archives/ || st-folder-fill # 子菜单名称：路径 || 图标 / Submenu name: path || icon
    #   全部分类: /categories/ || st-checkbox-multiple-blank-fill
      All tags: /tags/ || st-price-tag-fill
    # 友链:
...
hometop:
  ...
  banner:
    ...
    title: Strong but not aggressive<br>weak but not feeble.
    # 左上角显示小文字
  ...
  group:
    DS: /tags/Distrubute-System/ || st-fire-fill || linear-gradient(to right,#f65,#ffbf37)
    SA: /tags/System-Administration/ || st-book-mark-fill || linear-gradient(to right,#358bff,#15c6ff)
    AI: /tags/AI/ || st-star-smile-fill || linear-gradient(to right,#18e7ae,#1eebeb)
  ...
  recommendList:
    ...
    title: Solitude theme
    # 点击跳转链接
    # Click the jump link
    url: https://solitude-docs.efu.me/
    # 显示背景图片
    # Display background image
    img: /img/default3.png
    # 阴影颜色
    # Shadow color
    color: "none"
...
aside:
  ...
  card:
    ...
    # 文案1
    # label1
    content: Share my <b>passion</b> for programming, <b>aspiration</b> for a better life, and <b>journey</b> of exploring the ocean of knowledge.
    # 文案2
    # label2
    content2:
    # 个人信息卡片底部的小图标，按照例子填写
    ...
    # 个人信息卡片底部的小图标，按照例子填写
    information:
     Github: https://github.com/ankaiLiang || st-github-line # 名称：链接 || 图标 / Name: link || icon
     Instagram: https://www.instagram.com/ankai_liang/ || st-image-fill
     LinkedIn: https://www.linkedin.com/in/ankai-liang-a774b3119?trk=hp-identity-name || st-contacts-fill
     Facebook: https://www.facebook.com/lakeandgod || st-contacts-fill
     weibo: http://weibo.com/1783077873/profile?rightmod=1&wvr=6&mod=personnumber|| st-contacts-fill
...
page:
  ...
  categories: false # 分类页 /  Categories page
...
comment:
  ...
  # valine settings
  valine:
    appId: IK3GgkySRIkW22KzMxoiw10Y-MdYXbMMI # leancloud application app id
    appKey: iggekqbjE1jVkg8bcRkJHsQP # leancloud application app key
...
pwa:
  ...
  apple_touch_icon: /img/pwa/favicon.png # 苹果触摸图标
  bookmark_icon: /img/pwa/favicon.png # 书签图标
  favicon_32_32: /img/pwa/favicon.png # 32x32图标
  favicon_16_16: /img/pwa/favicon.png # 16x16图标
