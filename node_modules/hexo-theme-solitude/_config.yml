...
hometop:
  ...
  banner:
    ...
    title: Tranquility leads to distance<br>Love life
    # 左上角显示小文字
...
aside:
  ...
  card:
    ...
    # 文案1
    # label1
    content: Share my <b>journey</b> of exploring the ocean of knowledge.
    # 文案2
    # label2
    content2: Hope you find something you like
    # 个人信息卡片底部的小图标，按照例子填写
...
comment:
  ...
  waline: # https://waline.js.org/
    envId:  https://waline-comment-five-smoky.vercel.app/ # url: https://waline.wzsco.top
